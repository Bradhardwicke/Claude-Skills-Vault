---
name: workflow-builder-cs-workflow-build
skill-id: "workflow-builder:cs-workflow-build"
plugin: Workflow Builder
category: Engineering
tags: [skill, engineering, command]
aliases: ["/cs:workflow-build"]
triggers:
  - /cs:workflow-build
  - cs workflow build command
---
