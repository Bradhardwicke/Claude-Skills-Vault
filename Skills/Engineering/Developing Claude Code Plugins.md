...
skill-id: "superpowers-developing-for-claude-code:developing-claude-code-plugins"
plugin: Superpowers Dev
category: Engineering
tags: [skill, engineering, plugin-development]
aliases: ["Plugin Development", "Create Plugin", "Claude Code Plugin"]
triggers:
  - plugin development
  - create plugin
  - Claude Code plugin
