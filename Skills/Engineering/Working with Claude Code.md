...
skill-id: "superpowers-developing-for-claude-code:working-with-claude-code"
plugin: Superpowers Dev
category: Engineering
tags: [skill, engineering, claude-code]
aliases: ["Claude Code CLI", "Claude Code Features", "MCP Servers"]
triggers:
  - Claude Code CLI
