---
name: markdown-html-skills-cs-design-system
skill-id: "markdown-html-skills:cs-design-system"
plugin: Markdown HTML Skills
category: Writing
tags: [skill, markdown-html, command]
aliases: ["/cs:design-system"]
triggers:
  - /cs:design-system
  - cs design system command
  - markdown HTML brand setup
---
