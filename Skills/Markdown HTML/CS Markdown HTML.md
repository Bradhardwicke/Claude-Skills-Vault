---
name: markdown-html-skills-cs-markdown-html
skill-id: "markdown-html-skills:cs-markdown-html"
plugin: Markdown HTML Skills
category: Writing
tags: [skill, markdown-html, command]
aliases: ["/cs:markdown-html", "Markdown HTML Command"]
triggers:
  - /cs:markdown-html
  - cs markdown html command
  - route markdown HTML
---
