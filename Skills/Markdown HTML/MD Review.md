---
name: markdown-html-skills-md-review
skill-id: "markdown-html-skills:md-review"
plugin: Markdown HTML Skills
category: Writing
tags: [skill, markdown-html, writing]
aliases: ["PR Writeup HTML", "Code Review HTML", "Diff Annotation"]
triggers:
  - PR writeup HTML
  - code review HTML
  - diff annotation
  - review as HTML
  - severity tagged review
