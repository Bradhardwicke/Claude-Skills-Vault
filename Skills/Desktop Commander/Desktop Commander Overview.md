...
skill-id: desktop-commander:desktop-commander-overview
plugin: Desktop Commander
category: Desktop Commander
tags:
- skill
- desktop-commander
- terminal
...
- persistent shell
- REPL
- filesystem beyond workspace
- SSH remote
- ripgrep at scale
- long-running process
- cross-turn shell state
---
